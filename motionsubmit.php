  ...
  <body style="                  background-color:#4B92DB">
    <div id="templatemo_header_wrapper">
      <div id="templatemo_header">
        <div id="site_title"><a rel="nofollow" href="http://www.templatemo.com/preview/templatemo_375_tech_layer"><?php $echo = file_get_contents(committee_name.txt); echo "$echo"?><br />
          </a></div>
      </div>
    </div>
...
<INPUT TYPE="submit" VALUE="HOME">
              ...
              <table border="1" style="width: 400px; height: 475px;">
                <tbody>
                  <tr>
                    <td>
                      <div style="text-align: left;">
                        <form method="post" action="viewer.php">Write your
                          motion  <textarea name="motion" class="make_transparent"></textarea><br />
                          <br />
                          Write your country <input type="text" name="country"
                            class="make_transparent" /> <br />
                          <br />
                          <input type="hidden" value="1" name="nohelp" />
                          <div style="text-align: center;"> <input type="submit"
                              value="Make the motion" /><br />
                            <a href="motionmaker.php">In case you forgot how to
                              make a motion follow this link.</a></div>
                        </form>
                      </div>
                      <br />
                    </td>
            ...
            <div class="home_box right">
              <div class="row1 box5"><img src="logomun.gif" alt="" style="width: 113px; height: 113px;" /><br />
              </div>
              <img src="images/mun5.jpg" alt="" style="width: 196px; height: 113px;" /><img
                src="images/mun12.jpg" style="width: 187px; height: 114px;" alt="" />
              <div class="row2" id="home_gallery"> <img src="images/mun11.jpg"
                  alt="" style="width: 384px; height: 248px;" /></div>
            </div>
          </div>
          <!-- END of Home -->
