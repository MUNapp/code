  ...
  <body style="              background-color:#4B92DB">
    <div id="templatemo_header_wrapper">
      <div id="templatemo_header">
        <div id="site_title"><a rel="nofollow" href="http://www.templatemo.com/preview/templatemo_375_tech_layer">
...
<INPUT TYPE="submit" VALUE="HOME">
                ...
                <h3>SET COMMITTEE NAME<br /></h3>
              </div>
              <table border="1" style="width: 400px; height: 10px;">
                <tbody>
                  <tr>
                    <td>
                      <form  action="name.php" method="POST" target="name.php"><br />
                        <input type="text" 

                          name="namec" /> Name the Committee</br><input type="submit" value="Submit"><br />
                      </form>
                    </td>
                  </tr>
                </tbody>
            ...
            <div class="home_box right">
              <div class="row2" id="home_gallery">  <br />
                   <img src="logomun.gif" alt="" style="width: 259px; height: 259px;" /></div>
            </div>
          </div>
          <!-- END of Home -->
