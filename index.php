          ...
          <div id="home" class="section">
            <div class="home_box left">
              <div class="row1 box box1">
                <div class="box_with_padding">
                  <h2><a href="settings.php">Committee Settings<br />
                    </a></h2>
                   </div>
              </div>
              <div class="row1 box2">
                <div class="box_with_padding">
                  <a href="attendance.php"><h2>Attendance</h2></a>
                  <br />
              ...
              <div class="row1 box3">
                <div class="box_with_padding">
                  <h2><a href="viewerc.php">Motions</a></h2>
                </div>
              </div>
              <div class="row1 box4">
                <div class="box_with_padding">
                  <h2><a href="viewerslc.php">Speaker's List<br />
                    </a></h2>
                  <p><br />
                  </p>
                </div>
            ...
            <div class="home_box right">
              ...
              <div class="row2" id="home_gallery">  
				  ...
				  </br><a href="images/gallery/01-l.jpg"

                  rel="lightbox[home_gallery]" class="left"><img src="images/UN_General_Assembly_hall.jpg"

                    alt="image 1" style="width: 200px; height: 120px;" /></a> <a

                  href="images/gallery/02-l.jpg" rel="lightbox[home_gallery]" class="left"><img

                    src="images/Barack_Obama_chairs_a_United_Nations_Security_Council_meeting.jpg"

                    alt="image 2" style="width: 200px; height: 118px;" /></a> 
