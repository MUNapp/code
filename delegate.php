            ...
            <div class="home_box left">
              <div class="row1 box box1">
                <div class="box_with_padding">
                  <h2><a href="motionsubmit.php">Motion Reception</a></h2>
                  <p>Here you can share your motion.</p>
                </div>
              </div>
              <div class="row1 box2">
                <div class="box_with_padding">
                  <h2><a href="viewer.php">Motions Viewer</a></h2>
                  <p>Here you can see all the motions proposed.</p>
                </div>
              </div>
              <div class="row1 box3">
                <div class="box_with_padding">
                  <h2><a href="slmaker.php">Speaker's List Reception</a></h2>
                  <p>Here you can add yourself to the list.</p>
                </div>
              </div>
              <div class="row1 box4">
                <div class="box_with_padding">
                  <h2><a href="viewersl.php">View Speaker's List</a></h2>
