  ...
  <body>
    <div id="templatemo_header_wrapper">
      <div id="templatemo_header">
        <div id="site_title"><center><img width="50%" height="50%" src="logomun.gif" /></br><?php $echo = file_get_contents(committee_name.txt); echo "$echo"?> </div>
...
<INPUT TYPE="submit" VALUE="HOME">
            ...
            <table width="80%" border="1" align="center">
              <tbody>
                <tr>
                  <td>
				  <h2>MAKE SURE TO SAVE by clicking Excel logo.
				  </h2>
                    <div id="myExcelDiv" style="width: 600px; height: 400px" class="center"></div>
<script type="text/javascript" src="http://r.office.microsoft.com/r/rlidExcelWLJS?v=1&kip=1"></script>
<script type="text/javascript">
	/*
	 * This code uses the Microsoft Office Excel Javascript object model to programmatically insert the
	 * Excel Web App into a div with id=myExcelDiv. The full API is documented at
	 * http://msdn.microsoft.com/es-ES/library/hh315812.aspx. There you can find out how to programmatically get
	 * values from your Excel file and how to use the rest of the object model. 
	 */

	// Use this file token to reference NAME.xlsx in Excel's APIs
	var fileToken = "SDB59537337CBF0524!904/-5362319087038954204/t=0&s=0&v=!AEmXsNXVJ-aC7Wo";
	...
	function onEwaLoaded(result) {
		 ...
		 * Find out more at http://msdn.microsoft.com/es-ES/library/hh315812.aspx.
		 */
	}
</script><br />
                    <br />
